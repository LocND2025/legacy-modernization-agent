...
public class CobolNode
{
    ...
    public static CobolNode FromRecord(IRecord record)
    {
        ...
        return new CobolNode
        {
            ...
            SessionId = node.Properties.ContainsKey("sessionId") ? node.Properties["sessionId"].As<string>() : null,
            FileName = node.Properties["fileName"].As<string>(),
            RelativePath = node.Properties.ContainsKey("relativePath") ? node.Properties["relativePath"].As<string>() : null,
